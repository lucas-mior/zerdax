...
def parseargs():
    ...
    parser.add_argument('-a', nargs='?', type=int, default=020, help='Canny: low threshold')
    parser.add_argument('-b', nargs='?', type=int, default=120, help='Canny: high threshold')
    parser.add_argument('-c', nargs='?', type=int, default=070, help='Hough: votes')
    parser.add_argument('-d', nargs='?', type=int, default=150, help='Hough: minLen')
    parser.add_argument('-e', nargs='?', type=int, default=015, help='Hough: maxGap')
