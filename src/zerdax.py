...
def parseargs():
    ...
    parser.add_argument('-c_thrl', nargs='?', type=int, default=80,   help='Canny: low threshold')
    parser.add_argument('-c_thrh', nargs='?', type=int, default=180,  help='Canny: high threshold')
